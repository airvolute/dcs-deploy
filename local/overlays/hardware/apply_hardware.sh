...
# FIRST_BOOT service
sudo cp ${resources_path}/av_hw_hardware.service ${service_destination}/
sudo cp ${resources_path}/av_hw_hardware.sh ${bin_destination}/
sudo chmod +x ${bin_destination}/av_hw_hardware.sh

sudo ln -sf /etc/systemd/system/av_hw_hardware.service ${service_destination}/multi-user.target.wants/av_hw_hardware.service
