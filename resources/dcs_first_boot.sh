...
# Enable ethernet_switch_control service after start-up
sudo systemctl enable ethernet_switch_control.service
echo "Service enabled"
...
sudo systemctl start ethernet_switch_control.service
